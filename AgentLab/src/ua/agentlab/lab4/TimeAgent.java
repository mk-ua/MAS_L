  ...
  protected void setup() {
    ...
    addBehaviour(new TickerBehaviour(this, 1000) {
      protected void onTick() {
        System.out.println("Agent " + myAgent.getLocalName() + ": Behaviour1, tick=" + getTickCount());
      } 
    });
    
    final int time = 10000;
    final int max = time / 500;
    addBehaviour(new TickerBehaviour(this, 500) {
        protected void onTick() {
        	System.out.println("Agent " + myAgent.getLocalName() + ": Behaviour2, tick=" + (max - getTickCount()));
        } 
      });
