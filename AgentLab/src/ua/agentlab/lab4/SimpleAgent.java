...
public class SimpleAgent extends Agent {
  ...
  protected void setup() {
    ...
    addBehaviour(new CyclicBehaviour(this) {
      int count = 0;
      public void action() {
        System.out.println("Cycling " + ++count);
      } 
    });
    ...
    public void action() {
      ...
      case 2:
        ...
        myAgent.addBehaviour(new OneShotBehaviour(myAgent) {
          public void action() {
            System.out.println("One-shot on step 2");
          } 
        });
        break;
      case 3:
      ...
      case 4:
        ...
        break;
      case 5:
    	  System.out.println("Operation 5. Adding one-shot behaviour");
          myAgent.addBehaviour(new OneShotBehaviour(myAgent) {
            public void action() {
              System.out.println("One-shot on step 5");
            } 
          });
    	  break;
      }
