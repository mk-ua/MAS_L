...
public class FSMAgent extends Agent {
	...
	protected void setup() {
		...
		// Register state G
	    fsm.registerState(new RandomGenerator(5), STATE_G);
		...
		fsm.registerTransition(STATE_C, STATE_G, 0);
		fsm.registerTransition(STATE_C, STATE_D, 1);
		fsm.registerTransition(STATE_C, STATE_A, 2);
		fsm.registerTransition(STATE_G, STATE_F, 4);
		fsm.registerTransition(STATE_G, STATE_A, 3);
		fsm.registerTransition(STATE_G, STATE_C, 2);
		fsm.registerTransition(STATE_G, STATE_B, 1);
		fsm.registerDefaultTransition(STATE_G, STATE_G);
