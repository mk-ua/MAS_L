...
public class EmploymentOntology extends Ontology {
  ...
  public static final String MOSCOW_IS_FORBIDDEN = "MOSCOW-IS-FORBIDDEN";
  ...
  */
  ...
  private EmploymentOntology() {
    ...
    try {
		...
		add(new PredicateSchema(MOSCOW_IS_FORBIDDEN), MoscowIsForbidden.class);
    	...
    	cs.add(COMPANY_MANAGER, (ConceptSchema)getSchema(PERSON), ObjectSchema.OPTIONAL);
